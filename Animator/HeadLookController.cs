...
public class HeadLookController : MonoBehaviour {
	...
	private Transform m_defultTarget;

	public void ChangeTarget(Transform tTran)
	{
		ATarget = tTran;
	}
	...
	void Start () {
		...
		m_defultTarget = GameObject.Find ("CameraParent").transform.Find ("AR_Camera");
	...
	void LateUpdate () {
		...
		if (GameCtrl.g_CurGameState != EGameState.eGS_Interaction) {
			return;
		}
